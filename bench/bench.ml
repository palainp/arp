...
let gen_op buf off =
  ...
  Bytes.set_uint16_be buf off op

let gen_arp buf =
  hdr buf ;
  gen_op buf 6 ;
  let addresses = generate 20 in
  Bytes.blit addresses 0 buf 8 20 ;
  28

let gen_req buf =
  hdr buf ;
  Bytes.set_uint16_be buf 6 1 ;
  let addresses = generate 20 in
  Bytes.blit addresses 0 buf 8 20 ;
  28
...
let gen_ip () =
  ...
  let ip = "\010\000\000" ^ (Bytes.to_string last) in
...
let gen_rep buf =
  hdr buf ;
  Bytes.set_uint16_be buf 6 2 ;
  let omac = generate 6 in
  Bytes.blit omac 0 buf 8 6 ;
  let oip = gen_ip () in
  Bytes.blit_from_string (Ipaddr.V4.to_octets oip) 0 buf 14 4 ;
  Bytes.blit_from_string (Macaddr.to_octets mac) 0 buf 18 6 ;
  Bytes.blit_from_string (Ipaddr.V4.to_octets ip) 0 buf 24 4 ;
  28
...
let myreq buf =
  hdr buf ;
  Bytes.set_uint16_be buf 6 1 ;
  Bytes.blit_from_string (Macaddr.to_octets other_mac) 0 buf 8 6 ;
  Bytes.blit_from_string (Ipaddr.V4.to_octets other_ip) 0 buf 14 4 ;
  Bytes.blit_from_string (Macaddr.to_octets mac) 0 buf 18 6 ;
  Bytes.blit_from_string (Ipaddr.V4.to_octets ip) 0 buf 24 4 ;
  28
